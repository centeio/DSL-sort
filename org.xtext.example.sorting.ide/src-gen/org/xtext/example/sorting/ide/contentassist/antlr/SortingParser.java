		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getSourceAccess().getCodeAssignment_8(), "rule__Source__CodeAssignment_8");
					...
					put(grammarAccess.getFilterAccess().getCodeAssignment_9(), "rule__Filter__CodeAssignment_9");
					...
					put(grammarAccess.getSinkAccess().getCodeAssignment_8(), "rule__Sink__CodeAssignment_8");
